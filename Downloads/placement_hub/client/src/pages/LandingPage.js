    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Placement Hub</h1>
          </div>
          <Link
            to="/login"
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link
            to="/student-register"
            className="px-8 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition text-lg font-medium"
          >
            Register as Student
          </Link>
          {/* <Link
            to="/admin-register"
            className="px-8 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition text-lg font-medium"
          >
            Register as Admin
          </Link> */}
        </div>
