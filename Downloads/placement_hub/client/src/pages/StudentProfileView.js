...
import { FaTrophy, FaChartLine, FaUser, FaGraduationCap } from 'react-icons/fa';
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="border-t border-gray-100 pt-4 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-bold text-gray-900">{data.overallScore?.toLocaleString() || 0}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 text-sm">Roll: {data.studentInfo?.rollNumber || 'N/A'}</p>
              </div>
            </div>
